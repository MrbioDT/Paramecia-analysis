# 2nd version for analyzing the paramecia's locations in striking frames
...
if __name__ == '__main__':
    ...
    folder = 'D:\Videos_DT\\20180530_6th\\f6_single prey'
    ...
    for each_csv in csv_list:
        ...
        dataframe.to_csv(para_folder +"\\"+each_csv+"_sorted.csv", index=False, sep=',')
    ...
    dataframe.to_csv(folder + "\\" + "strike_para_location.csv", index=False, sep=',')
